...
export interface ApiArtistProfileArtistProfile extends Struct.SingleTypeSchema {
  collectionName: 'artist_profiles';
  info: {
    description: "Profil biographique de l'artiste";
  ...
  attributes: {
    ...
    distinctionText: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    distinctionTitle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    highlights: Schema.Attribute.Component<'bio.highlight', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    stats: Schema.Attribute.Component<'bio.stat', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiArtworkArtwork extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u0152uvres du portfolio';
    displayName: 'Artwork';
    pluralName: 'artworks';
  ...
  attributes: {
    ...
    priceXOF: Schema.Attribute.Integer & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    series: Schema.Attribute.Relation<'manyToOne', 'api::series.serie'>;
...
export interface ApiExhibitionExhibition extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    countriesList: Schema.Attribute.JSON &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Pages du site (home, works, biography, exhibitions, contact)';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiQuoteQuote extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Citations mises en avant';
    displayName: 'Quote';
    pluralName: 'quotes';
    singularName: 'quote';
  };
  ...
  attributes: {
    ...
    style: Schema.Attribute.Enumeration<['highlighted', 'bordered']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }> &
      Schema.Attribute.DefaultTo<'highlighted'>;
    title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiSectionItemSectionItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u00C9l\u00E9ment r\u00E9f\u00E9renc\u00E9 par une section (\u0153uvre, exposition ou citation)';
...
export interface ApiSectionSection extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blocs de contenu flexible assembl\u00E9s sur une page';
    displayName: 'Section';
    pluralName: 'sections';
...
export interface ApiSeriesSerie extends Struct.CollectionTypeSchema {
  collectionName: 'series';
  info: {
    description: "Groupes d'\u0153uvres (s\u00E9ries artistiques)";
    displayName: 'Series';
    pluralName: 'series';
    singularName: 'serie';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::series.serie'>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
...
export interface ApiSettingSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    instagramHandles: Schema.Attribute.JSON &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    quickLinks: Schema.Attribute.Relation<'manyToMany', 'api::page.page'>;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::series.serie': ApiSeriesSerie;
